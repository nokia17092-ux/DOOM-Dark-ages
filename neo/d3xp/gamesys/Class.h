...
public:
	...
	idEventArg( unsigned int data )				{ type = D_EVENT_INTEGER; value = data; };
	idEventArg( long data )						{ type = D_EVENT_INTEGER; value = data; };
	idEventArg( unsigned long data )				{ type = D_EVENT_INTEGER; value = data; };
	idEventArg( long long data )					{ type = D_EVENT_INTEGER; value = data; };
	idEventArg( unsigned long long data )			{ type = D_EVENT_INTEGER; value = data; };
	...
	idEventArg( const void *data )				{ type = D_EVENT_INTEGER; value = reinterpret_cast<intptr_t>( data ); };
